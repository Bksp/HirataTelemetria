...
<section id="uml-clases" class="content-section mb-4">
    <div class="glass-card p-4">
        ...
        <div class="d-flex justify-content-center">
            <img src="./img/DiagramaClases.png" alt="Diagrama de Clases" class="img-fluid rounded-3 shadow-lg" style="max-height: 600px; object-fit: contain;">
        </div>
    </div>
</section>
...
<section id="uml-arquitectura" class="content-section mb-4">
    <div class="glass-card p-4">
        ...
        <div class="d-flex justify-content-center">
            <img src="./img/DiagramaAltoNivel.png" alt="Diagrama de Arquitectura de Alto Nivel" class="img-fluid rounded-3 shadow-lg" style="max-height: 600px; object-fit: contain;">
        </div>
    </div>
</section>
    ...
    <div class="glass-card p-4">
        ...
        <div class="row g-4 justify-content-center">
            <div class="col-md-6 d-flex justify-content-center">
                <img src="./img/DiagramaActividades1.png" alt="Diagrama de Actividades 1" class="img-fluid rounded-3 shadow-lg" style="max-height: 600px; object-fit: contain;">
            </div>
            <div class="col-md-6 d-flex justify-content-center">
                <img src="./img/DiagramaActividades2.png" alt="Diagrama de Actividades 2" class="img-fluid rounded-3 shadow-lg" style="max-height: 600px; object-fit: contain;">
            </div>
        </div>
    </div>
</section>
...
<section id="uml-secuencia" class="content-section mt-4">
    <div class="glass-card p-4">
        ...
        <div class="d-flex justify-content-center">
            <img src="./img/DiagramaSecuencia.png" alt="Diagrama de Secuencia" class="img-fluid rounded-3 shadow-lg" style="max-height: 600px; object-fit: contain;">
        </div>
    </div>
</section>
...
<section id="uml-casos" class="content-section mt-4">
    <div class="glass-card p-4">
        ...
        <div class="d-flex justify-content-center mb-4">
            <img src="./img/CasosDeUso.png" alt="Diagrama de Casos de Uso" class="img-fluid rounded-3 shadow-lg" style="max-height: 600px; object-fit: contain;">
        </div>
    </div>
</section>`;async function s(e){e.innerHTML=a}export{s as init};
