const a=`<section id="docs-section" class="content-section mb-5 pt-4">
    <div class="glass-card p-5 mb-4">
        ...
        <p class="lead text-white text-opacity-75 m-0">
            Modelamiento estructural y flujo de arquitectura IoT para la cadena de distribución Hirata. El diseño integral del proyecto se detalla mediante seis diagramas: Clases, Arquitectura, Actividades, Secuencia, Casos de Uso y Modelo Entidad-Relación (MER).
        </p>
...
<!-- MER Diagram Card -->
<section id="uml-mer" class="content-section mt-4">
    <div class="glass-card p-4">
        <div class="d-flex justify-content-between align-items-center mb-3">
            <h4 class="h5 fw-bold text-white m-0"><i class="bi bi-database-fill text-secondary me-2"></i>6. Modelo Entidad-Relación (MER)</h4>
            <span class="badge badge-glass bg-secondary bg-opacity-25 text-secondary border-secondary border-opacity-50">Persistencia</span>
        </div>
        <p class="text-white text-opacity-70 small mb-4">
            Estructura de la base de datos relacional que soporta el almacenamiento de telemetría y configuración del sistema.
        </p>

        <!-- MER Image -->
        <div class="d-flex justify-content-center mb-4">
            <img src="https://raw.githubusercontent.com/Bksp/HirataTelemetria/refs/heads/main/src/demos/img/DiagramaMER.png" alt="Diagrama MER" class="img-fluid rounded-3 shadow-lg" style="max-height: 600px; object-fit: contain;">
        </div>
    </div>
